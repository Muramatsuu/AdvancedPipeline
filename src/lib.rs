// src/lib.rs
/*
 * Core library for AdvancedPipeline
 */
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AdvancedPipeline processing");
    
    let mut processor = AdvancedPipelineProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AdvancedPipelineProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AdvancedPipelineProcessor::new(false);
